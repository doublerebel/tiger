...
(function() {
  ...
  Tiger.Route = (function(_super) {
    ...
    Route.setup = function(options) {
      ...
      if (this.history) {
        History = (function(_super1) {
          __extends(History, _super1);
    ...
    Route.unbind = function() {
      if (this.history) {
        return this.History.unbind('refresh change', this.change);
      }
    };
  ...
  Tiger.Controller.include({
    ...
    back: function() {
      if (Tiger.Route.history) {
        return Tiger.Route.History.back();
      }
    }
  });
