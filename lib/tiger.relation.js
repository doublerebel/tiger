...
(function() {
  var BaseCollection, Collection, Instance, M2MCollection, O2MCollection, Singleton, Tiger, isArray, loadModel, singularize, underscore,
  ...
  O2MCollection = (function(_super) {
    ...
    function O2MCollection() {
      return O2MCollection.__super__.constructor.apply(this, arguments);
    }
    ...
    O2MCollection.prototype.all = function() {
      var lkey, _i, _len, _ref, _results;
      _ref = this.record[this.lkey];
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        lkey = _ref[_i];
  ...
  M2MCollection = (function(_super) {
    ...
    function M2MCollection() {
      return M2MCollection.__super__.constructor.apply(this, arguments);
    }
