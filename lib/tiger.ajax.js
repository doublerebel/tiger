...
(function() {
  ...
  Ajax = {
    ...
    queue: function(request) {
      ...
      (function(__iced_k) {
        ...
        return request(_this.pipeliner.__iced_deferrals.defer({
          lineno: 31
        }));
      });
    },
  ...
  Base = (function() {
    ...
    Base.prototype.ajaxQueue = function(params, defaults) {
      ...
      settings.success = rv.id('success').__iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            data = arguments[0];
      ...
      settings.error = rv.id('error').__iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            xhr = arguments[0];
            statusText = arguments[1];
